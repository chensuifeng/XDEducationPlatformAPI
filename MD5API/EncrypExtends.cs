    ...
    public static class EncrypExtends
     {
        ...
        //public static string DecryptFirst(string beinetkey, string message, bool encrypt, bool mode, string iv)
        //{
        //    return des(beinetkey, HexTostring(message), false, false, string.Empty);
        //}
